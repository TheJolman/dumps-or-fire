"""
Django settings for DumpsOrFire project.
...
WSGI_APPLICATION = 'DumpsOrFire.wsgi.application'
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'spotify/static/spotify'),
]
