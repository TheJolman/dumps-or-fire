"""
Django settings for dumps_or_fire project.
...
ALLOWED_HOSTS = [
    "jolman.pythonanywhere.com",
    "127.0.0.1",
    f"{APP_NAME}.fly.dev",
    "dumps-or-fire.fly.dev",
]
CSRF_TRUSTED_ORIGINS = [
    "https://*fly.dev",
    "https://dumps-or-fire.fly.dev",
]
...
ROOT_URLCONF = "dumps_or_fire.urls"
...
WSGI_APPLICATION = "dumps_or_fire.wsgi.application"
